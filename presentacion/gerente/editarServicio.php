...
if (isset($_POST["actualizar"])) {
    ...
    $nombreOriginal = strtolower($servicioOriginal->getNombre());
    $estadoOriginal = $servicioOriginal->getEstado();
    
    $nombresExistentes = array_column(Servicio::consultarTodos(), 'Nombre');
    $nombresFiltrados = array_filter($nombresExistentes, function($n) use ($nombreOriginal) {
        return strtolower($n) !== $nombreOriginal;
    });
        
       
        if (in_array(strtolower($nombre), array_map('strtolower', $nombresFiltrados))) {
            $mensaje = "<div class='alert alert-danger' role='alert'>
            ❌ Error: Ya existe un servicio con este nombre. No se puede actualizar.
        </div>";
            $modoEdicion = true;
        } else {
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?pid=<?php 
                                                    echo base64_encode("presentacion/gerente/editarServicio.php") 
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form action="?pid=<?php echo base64_encode("presentacion/gerente/editarServicio.php"); ?>" 
                                  method="POST" 
                                  id="formEditarServicio">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        id="nombre" 
                                        name="nombre"
                                        value="<?php echo htmlspecialchars($servicio->getNombre()); ?>" 
                                        required>

                                    <div id="feedbackNombre" class="mt-1" style="display:none;">
                                        <i class="fa-solid fa-triangle-exclamation text-warning"></i>
                                        <span class="text-danger fw-semibold">Ya existe otro servicio con este nombre.</span>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3"><?php 
                                        echo htmlspecialchars($servicio->getDescripcion()); 
                                    ?></textarea>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="precio" 
                                               name="precio"
                                               value="<?php echo htmlspecialchars($servicio->getPrecio()); ?>" 
                                               required>
                                    </div>

                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label fw-bold">Producto Asociado <span class="text-danger">*</span></label>
                                        <select class="form-select" id="idProducto" name="idProducto" required>
                                            ...
                                            foreach ($productos as $producto) {
                                                ...
                                                echo "<option value='{$producto['idProducto']}' {$selected}>" . 
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="?pid=<?php echo base64_encode("presentacion/gerente/editarServicio.php"); ?>" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validarNombre() {
        ...
        const duplicado = serviciosExistentes.includes(nombre);
        ...
        if (nombre === "") {
            ...
            feedbackNombre.innerHTML = `
                <i class="fa-solid fa-triangle-exclamation text-warning"></i>
                <span class="text-danger fw-semibold">El nombre no puede estar vacío.</span>
            `;
